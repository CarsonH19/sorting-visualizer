...
export default function Home() {
  ...
  return (
    <>
      <main className="absolute top-0 h-full w-screen z-[-2] bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#150229_1px)] bg-[size:40px_40px]">
        <div className="flex h-full justify-center">
          ...
          >
            ...
            <div className="relative h-[calc(100vh-66px)] w-full">
              <div className="absolute bottom-[16px] w-full mx-auto left-0 right-0 flex justify-center items-end">
